...
namespace IntegraKawe.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Address,Gender,Batch")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Address,Gender,Batch")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
